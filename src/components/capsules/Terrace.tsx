...
export default function Terrace({scrollYProgress, isActive}: TerracecProps) {
    ...
    const brightness2 = useTransform(scrollYProgress, [0.7, 1], ['brightness(1)', 'brightness(0.3)']);
    ...
    return (
        <motion.div
            style={{y: y1, scale: scale2, filter: brightness2, borderRadius: borderRadius2}}
        ...
        >
            ...
            <OpenDetails isVisible={isActive} text='The most prestige capsule with the biggest terrace
