...
export default function Capsules() {
    ...
    const [activeCapsule, setActiveCapsule] = useState<'classic' | 'terrace' | 'desert' | ''>('')
        ...
        <section className='p-2.5'>
            <div className="relative h-[600vh]" ref={containerRef}>
                <div className="sticky top-0 h-screen">
                    <InfiniteScrollText className='absolute top-1/2 right-0 overflow-hidden -translate-y-1/2'
                                        word='Capsules' duration={50} opacity={showInfiniteText ? 1 : 0}/>
                   <Classic scrollYProgress={scrollYProgress} isActive={activeCapsule === 'classic'}/>
                   <Terrace scrollYProgress={scrollYProgress} isActive={activeCapsule === 'terrace'}/>
                    <Desert scrollYProgress={scrollYProgress} isActive={activeCapsule === 'desert'}/>
                    {/*DESERT*/}
