...
export default function Classic({scrollYProgress, isActive}: ClassicProps){
    const scale1 = useTransform(scrollYProgress, [0, 0.25, 1 / 3, 0.7], [0.45, 1, 1, 0.9]);
    const scale1img = useTransform(scrollYProgress, [0, 0.25], [1.3, 1]);
    const brightness1 = useTransform(scrollYProgress, [1 / 3, 0.7], ['brightness(1)', 'brightness(0.3)']);
    ...
    return (
        ...
        >
            ...
            <OpenDetails isVisible={isActive} text='Classic Capsule® boasts refined aesthetics and a modern
